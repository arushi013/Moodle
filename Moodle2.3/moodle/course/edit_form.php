...
// Enrollment settings        
$mform->addElement('header','enrol', get_string('enrol'));
$mform->addHelpButton('enrol', 'enrol');

$mform->addElement('textarea', 'welcomemessage', get_string('welcomemessage'));
$mform->setDefault('welcomemessage', get_string('welcomemessagedesc'));
$mform->setType('welcomemessage', PARAM_TEXT);

$mform->addElement('checkbox','messagecheck', get_string('welcomemessagecheck'));
//$mform->addElement();
